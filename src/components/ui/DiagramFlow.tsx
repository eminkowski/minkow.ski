...
export function DiagramNode({ title, subtitle }: { title: string; subtitle?: string }) {
  return (
...
export const diagramShellClass =
  'flex flex-col gap-3 p-3 sm:p-4 rounded-lg border border-white/[0.06] bg-white/[0.02]'
